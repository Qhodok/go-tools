...
func (l *EchoLogger) Level() Lvl {
	return Lvl(atomic.LoadUint32(&l.level))
}

func (l *EchoLogger) SetLevel(level Lvl) {
...
func (l *EchoLogger) Color() *color.Color {
	return l.color
}
...
func (l *EchoLogger) Printj(j JSON) {
	l.log(0, "json", j)
}
...
func (l *EchoLogger) Debugj(j JSON) {
	l.log(DEBUG, "json", j)
}
...
func (l *EchoLogger) Infoj(j JSON) {
	l.log(INFO, "json", j)
}
...
func (l *EchoLogger) Warnj(j JSON) {
	l.log(WARN, "json", j)
}
...
func (l *EchoLogger) Errorj(j JSON) {
	l.log(ERROR, "json", j)
}
...
func (l *EchoLogger) Fatalj(j JSON) {
...
func (l *EchoLogger) Panicj(j JSON) {
...
func (l *EchoLogger) log(level Lvl, format string, args ...interface{}) {
